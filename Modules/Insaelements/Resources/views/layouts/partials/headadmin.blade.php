  ...
  <title>insa-elements | @yield('title')</title>
...
<script src= "{{ asset('AdminLTE-3.0.5/plugins/datatables-buttons/js/dataTables.buttons.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/datatables-buttons/js/buttons.bootstrap4.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/jszip/jszip.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/pdfmake/pdfmake.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/pdfmake/vfs_fonts.js')}}"></script>
<script src="{{ asset('AdminLTE-3.0.5/plugins/datatables-buttons/js/buttons.html5.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/datatables-buttons/js/buttons.print.min.js')}}"></script>
<script src= "{{ asset('AdminLTE-3.0.5/plugins/datatables-buttons/js/buttons.colVis.min.js')}}"></script>
<!-- AdminLTE App  <script src="{{asset('vendor/jquery-ui-1.12.1/jquery-ui.min.js')}}"></script>-->
